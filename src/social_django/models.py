...
class Nonce(models.Model, DjangoNonceMixin):
    ...
    server_url = models.CharField(
        _('Server url'), max_length=NONCE_SERVER_URL_LENGTH)
    timestamp = models.IntegerField(_('Timestamp'), )
    salt = models.CharField(_('Salt'), max_length=65)
...
class Association(models.Model, DjangoAssociationMixin):
    ...
    server_url = models.CharField(
        _('Server url'), max_length=ASSOCIATION_SERVER_URL_LENGTH)
    handle = models.CharField(
        _('Handle'), max_length=ASSOCIATION_HANDLE_LENGTH)
    ...
    assoc_type = models.CharField(_('Assoc type'), max_length=64)
